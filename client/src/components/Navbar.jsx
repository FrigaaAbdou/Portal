...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-30 border-b border-gray-200 bg-white/80 backdrop-blur relative">
      ...
      <div
        className={`fixed inset-0 z-20 bg-black/30 transition-opacity duration-300 md:hidden ${open ? 'opacity-100' : 'pointer-events-none opacity-0'}`}
      ...
      <div
        id="mobile-menu"
        className={`fixed right-0 top-0 z-30 h-screen w-72 max-w-[85vw] transform border-l border-gray-200 bg-white shadow-xl transition-transform duration-300 ease-out md:hidden ${
